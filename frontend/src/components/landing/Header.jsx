            ...
            {isAuthenticated ? (
              <>
                <Button
                  ...
                  className="bg-gradient-to-r from-primary-dark to-primary-teal hover:from-primary-teal hover:to-primary-dark text-white px-6 py-2.5 rounded-lg font-medium transition-all duration-300 hover:scale-110 hover:shadow-lg hover:shadow-primary-teal/50"
                >
                  Ir al Dashboard
                </Button>
                <ProfileDropdown
